...
def trans(video_path):
    #video_path = '/media/qinchangwei/DISK_IMG/回转窑气氛2021.11.9/二球/气氛清晰'+str(i+1)+str('.mp4')  # 视频文件地址，是视频文件
    timeF = 5  # 隔timeF帧截一次图，1表示全截


    #images_path = video_path.split('.', 1)[0]
    images_path = '/home/qinchangwei/xxx/predict'
